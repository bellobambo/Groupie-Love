...
const Header = () => {
  return (
    <div className="sticky top-0 z-50 w-full bg-[#007FFF] h-auto sm:h-[8vh] flex flex-col sm:flex-row items-center justify-between px-4 py-4 sm:py-0 gap-2 sm:gap-0">
